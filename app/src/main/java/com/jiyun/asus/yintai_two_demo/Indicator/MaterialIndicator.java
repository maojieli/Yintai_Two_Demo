package com.jiyun.asus.yintai_two_demo.Indicator;
...
//    private int defStyleAttr = 0;
    ...
    public MaterialIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //获得我们所定义的自定义样式属性
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.MaterialIndicator, defStyleAttr, R.style.MaterialIndicator);
        try {
            //获取指示点半径
            ...
            //获取颜色,并赋值给被选中的
            selectedIndicatorPaint.setColor(typedArray.getColor(R.styleable.MaterialIndicator_mi_indicatorColor, 0x10));
        } finally {
            typedArray.recycle();
        }
    }
