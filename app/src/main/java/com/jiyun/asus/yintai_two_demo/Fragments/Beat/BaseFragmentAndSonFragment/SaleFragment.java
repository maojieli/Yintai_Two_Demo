...
import com.jiyun.asus.yintai_two_demo.Fragments.Beat.Adapters.SaleLvAdapter;
 ...
 */
//即将开始
public class SaleFragment  extends  BaseFragment implements MyView<BeatBean>{
    ...
    private SaleLvAdapter adapters;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapters = new SaleLvAdapter(activitylistBeen, context);
