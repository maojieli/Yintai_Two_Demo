...
import com.jiyun.asus.yintai_two_demo.Adapters.BannerAdapter;
...
public class BannerActivity extends AppCompatActivity  implements ViewPager.OnPageChangeListener {
    ...
    private void initPoint() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (i == 0) {
                iv_point.setBackgroundResource(R.drawable.shapetwo);
            } else {
                iv_point.setBackgroundResource(R.drawable.shapeone);
            }
    ...
    private void initViewPager() {
        ...
        //实例化图片资源
        imageIdArray = new int[]{R.drawable.guide_img_one, R.drawable.guide_img_two, R.drawable.guide_img_three, R.drawable.guide_img_four};
        ...
        vp.setAdapter(new BannerAdapter(viewList));
        //设置滑动监听
...
//            ivPointArray[newPosition].setBackgroundResource();
//            if (newPosition != i) {
//                ivPointArray[i].setBackgroundResource(R.drawable.shapeone);
//            }
//        }
        ...
        int length = imageIdArray.length;
        for (int i = 0; i < length; i++) {
            ivPointArray[position].setBackgroundResource(R.drawable.shapetwo);
            if (position != i) {
                ivPointArray[i].setBackgroundResource(R.drawable.shapeone);
            }
        }
