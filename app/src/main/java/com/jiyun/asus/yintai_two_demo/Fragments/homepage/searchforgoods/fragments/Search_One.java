...
public class Search_One extends Fragment implements MyView<SearchBean>{
    ...
    public Search_One(SearchActivity searchActivity) {
    ...
    public void success(SearchBean searchBean) {
        List<SearchBean.DataBean.TagsBean> tags = searchBean.getData().get(0).getTags();
